...
export const App = () => {
  const aboutUs = '/static/menu-about-us.png';
  const simpleatom = '/static/menu-simpleatom.svg';
  const letsTalk = '/static/menu-lets-talk.svg';
  const telegram = '/static/menu-telegram.svg';
  const linkedIn = '/static/menu-linkedin.svg';
  const Lock = '/static/Lock.png';
  const Red_circle = '/static/Red_circle.svg';
  const Red_circle_cross = '/static/Red_circle_cross.svg';
  const Yellow_circle = '/static/Yellow_circle.svg';
  const Yellow_circle_minus = '/static/Yellow_circle_minus.svg';
  const Gray_circle = '/static/Gray_circle.svg';
  const themeLogo = '/static/light-theme-icon.png';
